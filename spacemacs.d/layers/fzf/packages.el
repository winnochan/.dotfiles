...
(defconst fzf-packages
  '(
    ;; (fzf :location (recipe :fetcher github :repo "dbalatero/fzf.el"))

    (fzf :location (recipe :fetcher git :url "https://gitee.com/winnochan/fzf.el"))
    )
  )  ;; Upstream
  ...
  (use-package fzf
    ...
    (progn
      (spacemacs/set-leader-keys
        "fzd"  'spacemacs/fzf-directory
        "fzf"  'spacemacs/fzf-projectile
        "fzg"  'spacemacs/fzf-git-files
        ))))
