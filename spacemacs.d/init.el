  ...
  (setq-default
   ...
   '(
     ...
     (go :variables
         ...
         ;; go-generate-buffer-name "*go gen*"
     ...
     (java :variables
           ...
           ;; java-backend 'lsp
           lsp-java-server-install-dir "~/.cache/java"
           )
     ...
     (typescript :variables
                 ...
                 ;; '(:includeCompletionsForModuleExports t :includeCompletionsForImportStatements t :useLabelDetailsInCompletionEntries t :allowIncompleteCompletions t :allowRenameOfImportPath t :includePackageJsonAutoImports t)
     ...
     ;; conda
     ;; (dap :variables
     ;;      ;; spacemacs--dap-supported-modes t
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; A value from the range (0..100), in increasing opacity, which describes the                                                                                                                                                                                                      ;; transparency level of a frame background when it's active or selected. Transparency                                                                                                                                                                                              ;; can be toggled through `toggle-background-transparency'. (default 90)
